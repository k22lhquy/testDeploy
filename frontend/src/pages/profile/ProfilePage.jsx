...
const ProfilePage = () => {
  ...
  const {selectedUser, setSelectedUser, authUser: my, checkAuth} = useChatStore();
  ...
  const amIFollowing = user?.followers?.includes(my?._id);
          ...
          {!isLoading && user && (
            <>
              ...
              <div className="flex justify-end px-4 mt-5">
                {isMyProfile && <EditProfileModal handleRefresh={handleRefresh} />}
                {!isMyProfile && (
